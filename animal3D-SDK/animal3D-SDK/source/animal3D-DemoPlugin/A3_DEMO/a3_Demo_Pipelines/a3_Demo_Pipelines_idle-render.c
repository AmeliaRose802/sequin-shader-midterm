...
void a3pipelines_render(a3_DemoState const* demoState, a3_Demo_Pipelines const* demoMode)
{
	...
	//Using existing mouse object and getting its position
	//a3f32 mousePos[2] = { (a3f32)demoState->mouse->x, (a3f32)demoState->mouse->y };
	a3vec2 mousePos = { (float)demoState->mouse->x, (float)demoState->mouse->y };
